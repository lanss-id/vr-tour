...
var _HideGalleryEvent = class _HideGalleryEvent extends import_core.TypedEvent {
  /** @internal */
  constructor() {
...
var GalleryComponent = class extends import_core4.AbstractComponent {
  constructor(plugin, viewer) {
    ...
    this.viewer.addEventListener(import_core4.events.SizeUpdatedEvent.type, this);
  ...
  destroy() {
    ...
    this.viewer.removeEventListener(import_core4.events.SizeUpdatedEvent.type, this);
  ...
  handleEvent(e) {
    switch (e.type) {
      ...
      case "scroll":
      case import_core4.events.SizeUpdatedEvent.type:
        this.__updateArrows();
        break;
      case "mousedown":
  ...
  hide() {
    ...
    if (import_core4.utils.hasParent(document.activeElement, this.container)) {
   ...
   */
  __click(e) {
    const item = import_core4.utils.getMatchingTarget(e, `.psv-gallery-item`);
    if (!item) {
      return;
    }
  ...
  __scroll(direction) {
    if (this.isAboveBreakpoint) {
      ...
      this.state.scrollLeft = import_three.MathUtils.clamp(this.state.scrollLeft + direction * scrollAmount, 0, maxScroll);
      ...
      this.state.scrollTop = import_three.MathUtils.clamp(this.state.scrollTop + direction * scrollAmount, 0, maxScroll);
  ...
  __updateArrows() {
    ...
    if (this.state.isAboveBreakpoint !== this.isAboveBreakpoint) {
      import_core4.utils.toggleClass(this.arrowLeft, "psv-gallery-arrow--left", this.isAboveBreakpoint);
      import_core4.utils.toggleClass(this.arrowLeft, "psv-gallery-arrow--top", !this.isAboveBreakpoint);
      import_core4.utils.toggleClass(this.arrowRight, "psv-gallery-arrow--right", this.isAboveBreakpoint);
      import_core4.utils.toggleClass(this.arrowRight, "psv-gallery-arrow--bottom", !this.isAboveBreakpoint);
...
var _GalleryPlugin = class _GalleryPlugin extends import_core5.AbstractConfigurablePlugin {
