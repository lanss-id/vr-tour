...
var ArrowsRenderer = class extends AbstractComponent {
  ...
  init() {
    ...
    if (this.is3D) {
      ...
      (_a2 = this.gallery) == null ? void 0 : _a2.addEventListener("show-gallery", this);
      (_b2 = this.gallery) == null ? void 0 : _b2.addEventListener("hide-gallery", this);
    }
  }
  destroy() {
    var _a2, _b2;
    ...
    (_a2 = this.gallery) == null ? void 0 : _a2.removeEventListener("show-gallery", this);
    (_b2 = this.gallery) == null ? void 0 : _b2.removeEventListener("hide-gallery", this);
    super.destroy();
  }
  handleEvent(e) {
    switch (e.type) {
  ...
  __buildArrowElement(link, style) {
    if (style == null ? void 0 : style.image) {
      const image = document.createElement("img");
      image.src = style.image;
      return image;
    } else if (style == null ? void 0 : style.element) {
...
var AbstractDatasource = class {
  ...
  checkNode(node) {
    ...
    if (this.plugin.isGps && !(((_a2 = node.gps) == null ? void 0 : _a2.length) >= 2)) {
      throw new PSVError(`No GPS position provided for node ${node.id}`);
    }
    if (!this.plugin.isGps && ((_b2 = node.markers) == null ? void 0 : _b2.some((marker) => marker.gps && !marker.position))) {
...
var ClientSideDatasource = class extends AbstractDatasource {
  ...
  setNodes(rawNodes) {
    if (!(rawNodes == null ? void 0 : rawNodes.length)) {
...
var _VirtualTourPlugin = class _VirtualTourPlugin2 extends AbstractConfigurablePlugin {
  ...
  init() {
    ...
    if ((_a2 = this.markers) == null ? void 0 : _a2.config.markers) {
    ...
    (_b2 = this.plan) == null ? void 0 : _b2.addEventListener("select-hotspot", this);
    if (this.isServerSide) {
  ...
  destroy() {
    var _a2, _b2;
    (_a2 = this.map) == null ? void 0 : _a2.removeEventListener("select-hotspot", this);
    (_b2 = this.plan) == null ? void 0 : _b2.removeEventListener("select-hotspot", this);
  ...
  handleEvent(e) {
    ...
    if (e instanceof events_exports.ClickEvent) {
      const link = (_a2 = e.data.objects.find((o) => o.userData[LINK_DATA])) == null ? void 0 : _a2.userData[LINK_DATA];
      if (link) {
  ...
  setCurrentNode(nodeId, options, fromLink) {
    var _a2;
    if (nodeId === ((_a2 = this.state.currentNode) == null ? void 0 : _a2.id) && !(options == null ? void 0 : options.forceUpdate)) {
      return Promise.resolve(true);
    }
    if ((options == null ? void 0 : options.forceUpdate) && this.isServerSide) {
    ...
    return Promise.resolve(this.state.preload[nodeId]).then(() => {
      ...
      if ((_a3 = this.gallery) == null ? void 0 : _a3.config.hideOnClick) {
        this.gallery.hide();
      }
      if ((_b2 = this.map) == null ? void 0 : _b2.config.minimizeOnHotspotClick) {
        this.map.minimize();
      }
      if ((_c = this.plan) == null ? void 0 : _c.config.minimizeOnHotspotClick) {
        this.plan.minimize();
      }
      ...
      (_a3 = this.markers) == null ? void 0 : _a3.clearMarkers();
      if (this.config.linksOnCompass) {
        (_b2 = this.compass) == null ? void 0 : _b2.clearHotspots();
      }
      ...
      (_a3 = this.plan) == null ? void 0 : _a3.setCoordinates(node.gps);
  ...
  getLinkPosition(nodeId) {
    var _a2;
    const link = (_a2 = this.state.currentNode) == null ? void 0 : _a2.links.find((link2) => link2.nodeId === nodeId);
    if (!link) {
  ...
  updateNode(newNode) {
    ...
    if (((_a2 = this.state.currentNode) == null ? void 0 : _a2.id) === node.id) {
      this.__hideTooltip();
      ...
      if (newNode.gps) {
        (_b2 = this.plan) == null ? void 0 : _b2.setCoordinates(node.gps);
      }
      if (newNode.map || newNode.gps) {
        (_c = this.map) == null ? void 0 : _c.setCenter(this.__getNodeMapPosition(node));
      }
  ...
  __renderLinks(node) {
    ...
    node.links.forEach((link) => {
      ...
      position.yaw += ((_a3 = link.linkOffset) == null ? void 0 : _a3.yaw) ?? 0;
      position.pitch += ((_b2 = link.linkOffset) == null ? void 0 : _b2.pitch) ?? 0;
      if (this.isGps && !this.is3D) {
        position.pitch += this.config.arrowsPosition.linkPitchOffset;
      }
      positions.push(position);
      this.arrowsRenderer.addLinkArrow(link, position, (_c = link.linkOffset) == null ? void 0 : _c.depth);
    });
    this.arrowsRenderer.render();
    if (this.config.linksOnCompass) {
      (_a2 = this.compass) == null ? void 0 : _a2.setHotspots(positions);
    }
  }
  /**
  ...
  __onEnterArrow(link, evt) {
    ...
    (_a2 = this.map) == null ? void 0 : _a2.setActiveHotspot(LINK_ID + link.nodeId);
    (_b2 = this.plan) == null ? void 0 : _b2.setActiveHotspot(LINK_ID + link.nodeId);
  ...
  __onHoverArrow(evt) {
    ...
    (_a2 = this.state.currentTooltip) == null ? void 0 : _a2.move({
      left: viewerPoint.x,
      top: viewerPoint.y
    });
  }
  ...
  __onLeaveArrow(link) {
    var _a2, _b2;
    this.__hideTooltip();
    (_a2 = this.map) == null ? void 0 : _a2.setActiveHotspot(null);
    (_b2 = this.plan) == null ? void 0 : _b2.setActiveHotspot(null);
  ...
  __hideTooltip() {
    var _a2;
    (_a2 = this.state.currentTooltip) == null ? void 0 : _a2.hide();
        ...
        this.markers.setMarkers(
          node.markers.map((marker) => {
            ...
            if (marker.gps && this.isGps) {
              ...
              if ((_a2 = marker.data) == null ? void 0 : _a2["map"]) {
                Object.assign(marker.data["map"], this.__getGpsMapPosition(marker.gps));
              }
              if ((_b2 = marker.data) == null ? void 0 : _b2["plan"]) {
...
@photo-sphere-viewer/virtual-tour-plugin/index.module.js:
  (*!
